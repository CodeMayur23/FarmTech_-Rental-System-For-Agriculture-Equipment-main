        ...
        <form id="add-product-form" enctype="multipart/form-data">
            ...
            <div class="col-12">
              <div class="form-group">
        		...
        		<div class="col-12">
        			<div class="form-group">
		        		<label>Location<small>(Available for which city)</small></label>
		        		<input type="text" name="product_keywords" class="form-control" placeholder="Enter Available Location">
		        	</div>
        		</div>
        		<div class="col-12">
        			<div class="form-group">
            ...
            <div class="col-12">
  <div class="form-group">
    <label for="product_video">Equipment Video</label>
    <input type="url" id="product_video" name="product_video" class="form-control" placeholder="Enter YouTube video URL">
    <small class="form-text text-muted">Provide a valid YouTube video link (e.g., https://www.youtube.com/watch?v=example).</small>
  </div>
</div>
...
<div class="modal fade" id="edit_product_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="form-group">
    <label for="product_video">Equipment Video</label>
    <input type="url" id="e_product_video" name="e_product_video" class="form-control" placeholder="Enter YouTube video URL">
    <small class="form-text text-muted">Provide a valid YouTube video link (e.g., https://www.youtube.com/watch?v=example).</small>
  </div>
</div>
